export const generateTextLeftImageRight = (data) => {
  const {
    bgColor = '#ffffff',
    ...
    copy = 'This is a description appearing on the left side of the image block, wrapping nicely on mobile.',
    copyColor = '#212121',
  ...
  <tr>
    ...
    <td class="vw100 ha db" style="width:492px;" valign="middle">
      <table role="presentation" class="vw60 ma" width="100%" dir="ltr" style="direction:ltr;font-family:Helvetica, Arial, sans-serif;">
        <!-- Headline -->
        <tr>
          <td class="padlr20 padb10 fs18 lh24" style="padding:0 20px 10px 40px; font-size:18px; line-height:24px; font-weight:bold;text-transform: uppercase; letter-spacing: .04em; font-family: Helvetica, Arial, sans-serif, 'Roboto'">
        ...
        <!-- Subcopy -->
        <tr>
          <td class="padlr20 padb20 fs14 lh22" style="padding:0 20px 20px 40px; font-size:14px; line-height:22px;">
        ...
        ${hideButton ? '' : `
        <tr>
          <td class="padb50 button tc" style="padding:0 20px 0 40px;">
    ...
    <td class="db pad0 padb10">
      <table role="presentation" style="width:20px; height:20px;">
        <tr>
          <td style="padding:0 0 20px 20px;"></td>
        </tr>
      </table>
    </td>
